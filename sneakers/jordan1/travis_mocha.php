...
<html>
    <head>
        <title>Travis Scott x Air Jordan 1 Retro High OG 'Mocha'</title>
      ...
      <section class="pdp-section">
        <div class="pdp-container-main">
          <div class="pdp-sinistra">
            <img class="foto1" src="../../img/Jordan1/TRAVIS_SCOTT_RETRO_HIGH_OG_MOCHA/tuttedue.jpeg">
            <div class="pdp-foto-metà">
              <img class="foto2" src="../../img/Jordan1/TRAVIS_SCOTT_RETRO_HIGH_OG_MOCHA/suola.jpeg">
              <img class="foto3" src="../../img/Jordan1/TRAVIS_SCOTT_RETRO_HIGH_OG_MOCHA/retro.jpeg">
            </div>
          </div>
          <div class="pdp-destra">
            <div class="pdp-text">
              <i>Nike</i>
      <h1>Travis Scott x Air Jordan 1 Retro High OG 'Mocha'</h1>
	 
      <h3>Descrizione</h3>
      <p>Le Travis Scott x Air Jordan 1 Retro High presentano un nuovo look sull'iconica silhouette, grazie a uno Swoosh oversize rivolto all'indietro sul lato laterale. Uno Swoosh tradizionalmente orientato abbellisce il lato mediale della tomaia, che è costruita con una miscela di pelle bianca e pelle scamosciata marrone. Ulteriori dettagli unici includono una costruzione a doppio strato sul colletto e il logo del viso disegnato in modo rozzo di Scott in rilievo sul tallone.
      </p>

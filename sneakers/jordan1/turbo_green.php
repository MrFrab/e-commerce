...
<html>
    <head>
        <title>Air Jordan 1 Retro High OG 'Turbo Green'</title>
...
<body>
  ...
  <div class="header" id="myHeader">
    ...
    <div class="contenitore-esterno">
      <section class="pdp-section">
        <div class="pdp-container-main">
          <div class="pdp-sinistra">
            <img class="foto1" src="../../img/Jordan1/RETRO_HIGH_OG_TURBO_GREEN/tuttedue.jpeg">
            <div class="pdp-foto-metà">
              <img class="foto2" src="../../img/Jordan1/RETRO_HIGH_OG_TURBO_GREEN/suola.jpeg">
              <img class="foto3" src="../../img/Jordan1/RETRO_HIGH_OG_TURBO_GREEN/retro.jpeg">
            </div>
          </div>
          <div class="pdp-destra">
            <div class="pdp-text">
              <i>Nike</i>
      <h1>Air Jordan 1 Retro High OG 'Turbo Green'</h1>
	 
      <h3>Descrizione</h3>
      <p>L'Air Jordan 1 Retro High OG "Turbo Green" completa le linee pulite della silhouette con un classico design bicolore. Una base in pelle bianca testurizzata è contrastata da morbide sovrapposizioni in pelle scamosciata in Turbo Green. Quest'ultimo elemento di design è brunito per emanare un'estetica vintage, una qualità ulteriormente esaltata da un'intersuola rifinita in Off-White Sail. Oltre a un'etichetta in tessuto Nike Air sulla linguetta in viola e giallo, il marchio esterno include anche una riga di testo alla base del pannello laterale che recita "SP 19 Air Jordan 1 High OG".
      </p>
	 ...
	 <a href="#"> <button class="add-cart" checked>ACQUISTA - 675€</button> </a>
            </div>
          </div>
        </div>
      </section>

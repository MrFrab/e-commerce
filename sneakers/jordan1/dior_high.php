...
<html>
    <head>
        <title>Dior x Air Jordan 1 High</title>
...
<body>
  ...
  <div class="header" id="myHeader">
    ...
    <div class="contenitore-esterno">
      <section class="pdp-section">
        <div class="pdp-container-main">
          <div class="pdp-sinistra">
            <img class="foto1" src="../../img/Jordan1/DIOR_HIGH/tuttedue.jpeg">
            <div class="pdp-foto-metà">
              <img class="foto2" src="../../img/Jordan1/DIOR_HIGH/suola.jpeg">
              <img class="foto3" src="../../img/Jordan1/DIOR_HIGH/retro.jpeg">
            </div>
          </div>
          <div class="pdp-destra">
            <div class="pdp-text">
              <i>Nike</i>
      <h1>Dior x Air Jordan 1 High</h1>
	 
      <h3 id="prova">Descrizione</h3>
      <p>Colmando il divario tra abbigliamento sportivo street-ready e moda di lusso, Dior x Air Jordan 1 High nasce da una collaborazione più ampia che abbraccia calzature, abbigliamento e accessori. L'interpretazione del designer Kim Jones dell'iconica sneaker utilizza una tomaia bianca e grigia realizzata in pelle italiana con bordi dipinti a mano. I successi del doppio marchio prendono la forma di un'etichetta in tessuto Dior sulla linguetta, uno Swoosh Nike in jacquard Dior Oblique e suole ghiacciate che rivelano un logo Dior e Dior Wings su ogni scarpa.
      </p>
    
	
		<h4>Taglie</h4>
       <div class="grid-container">
       <form action="dior_high.php#prova" method="get" style="display:contents;">
      ...
      <input type="text" name="nomeScarpa" value="Dior x Air Jordan 1 High" hidden>
    <input type="number" name="prezzo" value="12000" hidden>
    <input type="number" name="quantita" value="1" hidden>
    <button name="invia" class="add-cart" type="submit" checked>ACQUISTA - 12000€</button>

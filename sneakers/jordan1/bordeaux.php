...
<html>
    <head>
        <title>Air Jordan 1 Retro High OG 'Bordeaux'</title>
      ...
      <section class="pdp-section">
        <div class="pdp-container-main">
          <div class="pdp-sinistra">
            <img class="foto1" src="../../img/Jordan1/RETRO_HIGH_OG_BORDEAUX/tuttedue.jpeg">
            <div class="pdp-foto-metà">
              <img class="foto2" src="../../img/Jordan1/RETRO_HIGH_OG_BORDEAUX/suola.jpeg">
              <img class="foto3" src="../../img/Jordan1/RETRO_HIGH_OG_BORDEAUX/retro.jpeg">
            </div>
          </div>
          <div class="pdp-destra">
            <div class="pdp-text">
              <i>Nike</i>
              <h1>Air Jordan 1 Retro High OG 'Bordeaux'</h1>
           
              <h3 id="prova">Descrizione</h3>
              <p>L'Air Jordan 1 Retro High OG "Bordeaux" veste la silhouette archetipica con una tomaia in pelle bianca con sovrapposizioni in pelle vinosa sull'avampiede, sul tallone e sul colletto. Simile alla colorazione CO.JP "Midnight Navy", la sneaker è accentata con uno Swoosh argento metallizzato e un logo Wings ingioiellato sulla caviglia laterale. Una linguetta Nike Air intrecciata sopra la linguetta in nylon leggermente imbottita offre un tocco OG. La tradizionale suola preformata AJ1 bicolore racchiude l'ammortizzazione Nike Air sotto il tallone.
              </p>
            
          
            <h4>Taglie</h4>
               <div class="grid-container">
               <form action="bordeaux.php#prova" method="get" style="display:contents;">
              ...
              <input type="text" name="nomeScarpa" value="Air Jordan 1 Retro High OG Bordeaux" hidden>
    <input type="number" name="prezzo" value="210" hidden>
    <input type="number" name="quantita" value="1" hidden>
    <button name="invia" class="add-cart" type="submit" checked>ACQUISTA - 210€</button>

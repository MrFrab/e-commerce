...
<html>
    <head>
        <title>A Ma Maniére x Air Jordan 1 High OG 'Airness'</title>
      ...
      <section class="pdp-section">
        <div class="pdp-container-main">
          <div class="pdp-sinistra">
            <img class="foto1" src="../../img/Jordan1/A_MA_MANIERE_HIGH_OG_AIRNESS/tuttedue.jpeg">
            <div class="pdp-foto-metà">
              <img class="foto2" src="../../img/Jordan1/A_MA_MANIERE_HIGH_OG_AIRNESS/suola.jpeg">
              <img class="foto3" src="../../img/Jordan1/A_MA_MANIERE_HIGH_OG_AIRNESS/retro.jpeg">
            </div>
          </div>
          <div class="pdp-destra">
            <div class="pdp-text">
              <i>Nike</i>
      <h1>A Ma Maniére x Air Jordan 1 High OG 'Airness'</h1>
	 
      <h3 id="prova">Descrizione</h3>
      <p>Le A Ma Maniére x Air Jordan 1 High OG "Airness" rappresentano il seguito della collaborazione di successo con Air Jordan 3 dei partner creativi della primavera 2021. L'iconica silhouette sostituisce la tradizionale costruzione in pelle con una tomaia in pelle scamosciata testurizzata in un delicato bianco sporco finire. I tocchi premium includono la pelle di serpente bordeaux sul colletto e lo Swoosh, insieme a una fodera trapuntata in raso nella stessa tonalità autunnale. Un tradizionale logo Wings è stampato sulla patta del colletto, il cui lato interno presenta la firma di MJ e un'iscrizione che recita "Devi aspettarti cose da te prima di poterle fare". Loghi Air e A Ma Maniére. Le corse alte su un'intersuola pre-ingiallita e suola in gomma bordeaux.
      </p>
  
      <h4>Taglie</h4>
      <div class="grid-container">
   
<form action="A_MA_MANIERE_HIGH_OG_AIRNESS.php#prova" method="get" style="display:contents;">
     ...
     <input type="text" name="nomeScarpa" value="A Ma Maniere x Air Jordan 1 High OG Airness" hidden>
    <input type="number" name="prezzo" value="470" hidden>
    <input type="number" name="quantita" value="1" hidden>
    <button name="invia" class="add-cart" type="submit" checked>ACQUISTA - 470€</button>

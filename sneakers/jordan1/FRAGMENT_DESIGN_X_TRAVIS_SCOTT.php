...
<html>
    <head>
        <title>Fragment Design x Travis Scott x Air Jordan 1 Retro High</title>
...
<body>
  ...
  <div class="header" id="myHeader">
    ...
    <div class="contenitore-esterno">
      <section class="pdp-section">
        <div class="pdp-container-main">
          <div class="pdp-sinistra">
            <img class="foto1" src="../../img/Jordan1/FRAGMENT_DESIGN_X_TRAVIS_SCOTT/tuttedue.jpeg">
            <div class="pdp-foto-metà">
              <img class="foto2" src="../../img/Jordan1/FRAGMENT_DESIGN_X_TRAVIS_SCOTT/suola.jpeg">
              <img class="foto3" src="../../img/Jordan1/FRAGMENT_DESIGN_X_TRAVIS_SCOTT/retro.jpeg">
            </div>
          </div>
          <div class="pdp-destra">
            <div class="pdp-text">
              <i>Nike</i>
      <h1>Fragment Design x Travis Scott x Air Jordan 1 Retro High</h1>
	 
      <h3>Descrizione</h3>
      <p>Il Fragment Design x Travis Scott x Air Jordan 1 Retro High riunisce due dei partner creativi più influenti del marchio Jordan. Il design risultante trova la sneaker fondamentale vestita in pelle martellata bianca con il caratteristico Swoosh invertito di Scott in pelle nera a contrasto. Simile alla collaborazione AJ1 del rapper del 2019, una custodia nascosta è integrata nel colletto in nylon nero. I colpi di colore blu militare a contrasto si posano sulla punta, sul risvolto del colletto e sul rivestimento del tallone. Quest'ultimo è stampato con il logo del fulmine di Fragment sulla scarpa destra e la faccina sorridente Cactus Jack di La Flame sulla sinistra. Ulteriori elementi di branding includono un'etichetta sulla linguetta tessuta Nike Air standard, un'etichetta sulla linguetta Cactus Jack secondaria e un classico logo Jordan Wings stampato sulla caviglia laterale. Una suola in gomma con pareti laterali ingiallite conferisce alla scarpa un'estetica vintage.
      </p>
	 ...
	 <a href="#"> <button class="add-cart" checked>ACQUISTA - 4800€</button> </a>
            </div>
          </div>
        </div>
      </section>

...
<html>
    <head>
        <title>Off-White x Air Jordan 1 Retro High OG 'Chicago'</title>
...
<body>
  ...
  <div class="header" id="myHeader">
    ...
    <div class="contenitore-esterno">
      <section class="pdp-section">
        <div class="pdp-container-main">
          <div class="pdp-sinistra">
            <img class="foto1" src="../../img/Jordan1/OFF-WHITE_RETRO_HIGH_OG_CHICAGO/tuttedue.jpeg">
            <div class="pdp-foto-metà">
              <img class="foto2" src="../../img/Jordan1/OFF-WHITE_RETRO_HIGH_OG_CHICAGO/suola.jpeg">
              <img class="foto3" src="../../img/Jordan1/OFF-WHITE_RETRO_HIGH_OG_CHICAGO/retro.jpeg">
            </div>
          </div>
      ...
      <p>Creata dal designer Virgil Abloh, la Air Jordan 1 x Off-White è disponibile nella classica colorazione Chicago. Alcune delle caratteristiche semifinite delle sneakers includono uno Swoosh collegato alla scarpa con cuciture blu visibili, "Air" stampato sull'intersuola e una fascetta con cerniera Off-White sul colletto. La scatola viene smontata in quanto è stata capovolta con l'interno costituito da una base nera e il logo Jumpman dorato, mentre l'esterno è in cartone semplice con le parole "Jumpman" stampate su di esso. La collezione Off-White di Virgil includeva iterazioni remixate di Air VaporMax, Air Presto, Air Max 90, Blazer, Air Max 97, Hyperdunk 2017, Air Force 1, Zoom Fly e Chuck Taylor.
      </p>
    
	
		<h4>Taglie</h4>
       <div class="grid-container">
       <form action="chicago_off.php#prova" method="get" style="display:contents;">
      ...
      <input type="text" name="nomeScarpa" value="Off-White x Air Jordan 1 Retro High OG Chicago" hidden>
    <input type="number" name="prezzo" value="11400" hidden>
    <input type="number" name="quantita" value="1" hidden>
    <button name="invia" class="add-cart" type="submit" checked>ACQUISTA - 11400€</button>

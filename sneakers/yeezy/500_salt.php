...
<body>
  ...
  <div class="header" id="myHeader">
    ...
    <div class="contenitore-esterno">
      <section class="pdp-section">
        <div class="pdp-container-main">
          <div class="pdp-sinistra">
            <img class="foto1" src="../../img/YEEZY/500_SALT/tuttedue.jpeg">
            <div class="pdp-foto-metà">
              <img class="foto2" src="../../img/YEEZY/500_SALT/suola.jpeg">
              <img class="foto3" src="../../img/YEEZY/500_SALT/retro.jpeg">
            </div>
          </div>
          <div class="pdp-destra">
            <div class="pdp-text">
              <i>Adidas</i>
      <h1>Yeezy 500 'Salt'</h1>
	 
      <h3 id="prova">Descrizione</h3>
      <p>La Yeezy 500 "Salt" ha lo stesso design monocromatico utilizzato nelle precedenti colorazioni della voluminosa silhouette lifestyle. Qui, una tonalità grigio chiaro viene applicata alla tomaia a strati, costruita con una combinazione di pelle scamosciata di mucca, pelle premium, mesh e dettagli in nabuk. Un rivestimento in gomma sopra l'intersuola offre una maggiore durata, mentre il rivestimento riflettente intorno agli occhielli offre visibilità in condizioni di scarsa illuminazione.
      </p>
    
	
		<h4>Taglie</h4>
       <div class="grid-container">
       <form action="500_salt.php#prova" method="get" style="display:contents;">
      ...
      <input type="text" name="nomeScarpa" value="Yeezy 500 Salt" hidden>
    <input type="number" name="prezzo" value="480" hidden>
    <input type="number" name="quantita" value="1" hidden>
    <button name="invia" class="add-cart" type="submit" checked>ACQUISTA - 480€</button>
    <?php
    if($controllo){

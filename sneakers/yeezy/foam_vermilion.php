...
<html>
    <head>
        <title>Yeezy Foam Runner 'Vermilion'</title>
...
<body>
  ...
  <div class="header" id="myHeader">
    ...
    <div class="contenitore-esterno">
      <section class="pdp-section">
        <div class="pdp-container-main">
          <div class="pdp-sinistra">
            <img class="foto1" src="../../img/YEEZY/FOAM_VERMILION/tuttedue.jpeg">
            <div class="pdp-foto-metà">
              <img class="foto2" src="../../img/YEEZY/FOAM_VERMILION/suola.jpeg">
              <img class="foto3" src="../../img/YEEZY/FOAM_VERMILION/retro.jpeg">
            </div>
          </div>
          <div class="pdp-destra">
            <div class="pdp-text">
              <i>Adidas</i>
      <h1>Yeezy Foam Runner 'Vermilion'</h1>
	 
      <h3 id="prova">Descrizione</h3>
      <p>L'adidas Yeezy Foam Runner "Vermilion" applica una finitura scarlatta a una nota alla silhouette simile a uno zoccolo, segnando la prima volta che Kanye West ha introdotto la familiare tavolozza monocromatica nella sua collaborazione con le Three Stripes. Il futuristico slip-on presenta una costruzione sostenibile, evidenziata da un unico pezzo di schiuma realizzato in parte con alghe prodotte idroponica. Le aperture di ventilazione su tutta la tomaia e sui pannelli laterali offrono un comfort traspirante, mentre il tallone scolpito è progettato per cullare la parte posteriore del piede per una vestibilità antiscivolo.
      </p>
    
	
		<h4>Taglie</h4>
       <div class="grid-container">
       <form action="foam_vermilion.php#prova" method="get" style="display:contents;">
      ...
      <input type="text" name="nomeScarpa" value="Yeezy Foam Runner Vermilion" hidden>
    <input type="number" name="prezzo" value="280" hidden>
    <input type="number" name="quantita" value="1" hidden>
    <button name="invia" class="add-cart" type="submit" checked>ACQUISTA - 280€</button>
    <?php
    if($controllo){

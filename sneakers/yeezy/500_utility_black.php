...
<html>
    <head>
        <title>Yeezy 500 'Utility Black'</title>
...
<body>
  ...
  <div class="header" id="myHeader">
    ...
    <div class="contenitore-esterno">
      <section class="pdp-section">
        <div class="pdp-container-main">
          <div class="pdp-sinistra">
            <img class="foto1" src="../../img/YEEZY/500_UTILITY_BLACK/tuttedue.jpeg">
            <div class="pdp-foto-metà">
              <img class="foto2" src="../../img/YEEZY/500_UTILITY_BLACK/suola.jpeg">
              <img class="foto3" src="../../img/YEEZY/500_UTILITY_BLACK/retro.jpeg">
            </div>
          </div>
          <div class="pdp-destra">
            <div class="pdp-text">
              <i>Adidas</i>
      <h1>Yeezy 500 'Utility Black'</h1>
	 
      <h3 id="prova">Descrizione</h3>
      <p>Kanye West e adidas hanno lanciato la Yeezy 500 "Utility Black" a luglio 2018. La silhouette di ispirazione retrò controbilancia la sua forma voluminosa con un design elegante e completamente nero. Ciò che distingue questa colorazione dalla finitura tripla nera standard è un uso singolare del tono: è un nero semi-sbiadito che ricopre la tomaia in mesh e pelle scamosciata, al contrario della varietà nera come la pece che è più comune nel firmamento delle sneaker.
      </p>
    
	
		<h4>Taglie</h4>
       <div class="grid-container">
       <form action="500_utility_black.php#prova" method="get" style="display:contents;">
      ...
      <input type="text" name="nomeScarpa" value="Yeezy 500 Utility Black" hidden>
    <input type="number" name="prezzo" value="420" hidden>
    <input type="number" name="quantita" value="1" hidden>
    <button name="invia" class="add-cart" type="submit" checked>ACQUISTA - 420€</button>
    <?php
    if($controllo){

...
<html>
    <head>
        <title>Yeezy Boost 350 V2 'Black Reflective'</title>
      ...
      <section class="pdp-section">
        <div class="pdp-container-main">
          <div class="pdp-sinistra">
            <img class="foto1" src="../../img/YEEZY/350_BLACK_REFLECTIVE/tuttedue.jpeg">
            <div class="pdp-foto-metà">
              <img class="foto2" src="../../img/YEEZY/350_BLACK_REFLECTIVE/suola.jpeg">
              <img class="foto3" src="../../img/YEEZY/350_BLACK_REFLECTIVE/retro.jpeg">
            </div>
          </div>
          <div class="pdp-destra">
            <div class="pdp-text">
              <i>Adidas</i>
      <h1>Yeezy Boost 350 V2 'Black Reflective'</h1>
	 
      <h3 id="prova">Descrizione</h3>
      <p>La Yeezy Boost 350 V2 è stata avvistata per la prima volta durante la Yeezy Season 3 di Kanye West e rilasciata a settembre 2016. Questa colorazione "Black Reflective" è atterrata a giugno 2019 e proietta la tomaia flessibile Primeknit della scarpa in quella che sembra essere una tonalità esclusivamente nera. Quando vengono colpiti dalla luce diretta, i lacci e la tomaia della scarpa rivelano potenti elementi riflettenti cuciti nel design. La sensazione reattiva dell'ammortizzazione adidas Boost a tutta lunghezza rimane su una suola in gomma resistente.
      </p>
...
<form action="350_black_rf.php#prova" method="get" style="display:contents;">
      ...
      <input type="text" name="nomeScarpa" value="Yeezy Boost 350 V2 Black Reflective" hidden>
    <input type="number" name="prezzo" value="490" hidden>
    <input type="number" name="quantita" value="1" hidden>
    <button name="invia" class="add-cart" type="submit" checked>ACQUISTA - 490€</button>
    <?php
    if($controllo){

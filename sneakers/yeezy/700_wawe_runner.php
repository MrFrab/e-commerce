...
<html>
    <head>
        <title>Yeezy Boost 700 'Wave Runner'</title>
...
<body>
  ...
  <div class="header" id="myHeader">
    ...
    <div class="contenitore-esterno">
      <section class="pdp-section">
        <div class="pdp-container-main">
          <div class="pdp-sinistra">
            <img class="foto1" src="../../img/YEEZY/700_WAVE_RUNNER/tuttedue.jpeg">
            <div class="pdp-foto-metà">
              <img class="foto2" src="../../img/YEEZY/700_WAVE_RUNNER/suola.jpeg">
              <img class="foto3" src="../../img/YEEZY/700_WAVE_RUNNER/retro.jpeg">
            </div>
          </div>
      ...
      <h3>Descrizione</h3>
      <p>Questa colorazione inaugurale della Yeezy Wave Runner 700 di Kanye West è stata lanciata a novembre 2017, dopo un debutto pubblico all'inizio dell'anno come parte della sfilata della quinta stagione di Yeezy. Le linee di ispirazione retrò della sneaker hanno lavorato in tandem con una silhouette robusta che ricorda un'era precedente. Una base in rete è rifinita in grigio sui pannelli laterali e blu brillante e verde acqua sull'avampiede. Sovrapposizioni in pelle scamosciata arrivano sugli occhielli in pelle grigia accentati sulla punta e sul tallone. Altri dettagli includono lacci verde neon, un'intersuola bianca voluminosa e tocchi di nero e arancione brillante.
      </p>
	 ...
	 <a href="#"> <button class="add-cart" checked>ACQUISTA - 490€</button> </a>
            </div>
          </div>
        </div>
      </section>

...
<html>
    <head>
        <title>Yeezy Boost 350 V2 'Zebra'</title>
...
<body>
  ...
  <div class="header" id="myHeader">
    ...
    <div class="contenitore-esterno">
      <section class="pdp-section">
        <div class="pdp-container-main">
          <div class="pdp-sinistra">
            <img class="foto1" src="../../img/YEEZY/350_ZEBRA/tuttedue.jpeg">
            <div class="pdp-foto-metà">
              <img class="foto2" src="../../img/YEEZY/350_ZEBRA/suola.jpeg">
              <img class="foto3" src="../../img/YEEZY/350_ZEBRA/retro.jpeg">
            </div>
          </div>
      ...
      <p>Rilasciata il 25 febbraio 2017, la Yeezy Boost 350 V2 "Zebra" combina una tomaia Primeknit bianca/core nera con il marchio SPLY 350 rosso e un'intersuola bianca traslucida che ospita Boost a tutta lunghezza. Venduta esclusivamente su adidas.com, Yeezy Supply e selezionati flagship store adidas, la "Zebra" è andata esaurita all'istante ma è stata rifornita il 24 giugno 2017. Un altro rifornimento della "Zebra" è arrivato il 16 novembre 2018, con più paia che colpiscono il mercato e mantenendo la promessa di Kanye di rendere Yeezy più accessibile a chiunque li volesse.
      </p>
...
<form action="350_zebra.php#prova" method="get" style="display:contents;">
      ...
      <input type="text" name="nomeScarpa" value="Yeezy Boost 350 V2 Zebra" hidden>

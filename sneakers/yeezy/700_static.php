...
<html>
    <head>
        <title>Yeezy Boost 700 V2 'Static'</title>
...
<body>
  ...
  <div class="header" id="myHeader">
    ...
    <div class="contenitore-esterno">
      <section class="pdp-section">
        <div class="pdp-container-main">
          <div class="pdp-sinistra">
            <img class="foto1" src="../../img/YEEZY/700_STATIC/tuttedue.jpeg">
            <div class="pdp-foto-metà">
              <img class="foto2" src="../../img/YEEZY/700_STATIC/suola.jpeg">
              <img class="foto3" src="../../img/YEEZY/700_STATIC/retro.jpeg">
            </div>
          </div>
          <div class="pdp-destra">
            <div class="pdp-text">
              <i>Adidas</i>
      <h1>Yeezy Boost 700 V2 'Static'</h1>
	 
      <h3>Descrizione</h3>
      <p>Yeezy Boost 700 V2 "Static" è un aggiornamento dell'originale Wave Runner. La tomaia presenta un design leggermente rielaborato, mentre l'intersuola rimane la stessa. Questa nuova edizione mette in mostra una colorazione sobria composta da sfumature morbide e neutre. La composizione a strati della tomaia, caratterizzata da una base in rete con sovrapposizioni riflettenti saldate e pannelli in pelle, è rifinita in diverse tonalità di grigio e bianco. L'intersuola voluminosa caratteristica della silhouette, rifinita in bianco abbinato, è supportata sotto i piedi da una suola in gomma nera.
      </p>
	 ...
	 <a href="#"> <button class="add-cart" checked>ACQUISTA - 1000€</button> </a>

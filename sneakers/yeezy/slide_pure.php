      ...
      <section class="pdp-section">
        <div class="pdp-container-main">
          <div class="pdp-sinistra">
            <img class="foto1" src="../../img/YEEZY/SLIDE_PURE/tuttedue.jpeg">
            <div class="pdp-foto-metà">
              <img class="foto2" src="../../img/YEEZY/SLIDE_PURE/suola.jpeg">
              <img class="foto3" src="../../img/YEEZY/SLIDE_PURE/retro.jpeg">
            </div>
          </div>
          <div class="pdp-destra">
            <div class="pdp-text">
              <i>Adidas</i>
      <h1>Yeezy Slides 'Pure'</h1>
	 
      <h3 id="prova">Descrizione</h3>
      <p>L'adidas Yeezy Slide "Pure" evidenzia una finitura beige a una nota su tutto l'esterno della slip-on. La schiuma EVA iniettata leggera e resistente costituisce la composizione della struttura monopezzo. Il design minimalista è contrassegnato da un logo adidas in rilievo sullo strato superiore morbido del plantare, ottimo per un comfort immediato. Sotto i piedi, la suola è configurata con profonde scanalature flessibili per una corsa fluida e una presa ottimale.
      </p>
...
<form action="slide_pure.php#prova" method="get" style="display:contents;">
      ...
      <input type="text" name="nomeScarpa" value="Yeezy Slides Pure" hidden>
    <input type="number" name="prezzo" value="200" hidden>
    <input type="number" name="quantita" value="1" hidden>
    <button name="invia" class="add-cart" type="submit" checked>ACQUISTA - 200€</button>
    <?php
    if($controllo){

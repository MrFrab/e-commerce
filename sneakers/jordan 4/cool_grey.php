...
<html>
    <head>
        <title>Air Jordan 4 Retro 'Cool Grey' 2019</title>
...
<body>
  ...
  <div class="header" id="myHeader">
    ...
    <div class="contenitore-esterno">
      <section class="pdp-section">
        <div class="pdp-container-main">
          <div class="pdp-sinistra">
            <img class="foto1" src="../../img/Jordan4/COOL_GRAY/tuttedue.jpeg">
            <div class="pdp-foto-metà">
              <img class="foto2" src="../../img/Jordan4/COOL_GRAY/suola.jpeg">
              <img class="foto3" src="../../img/Jordan4/COOL_GRAY/retro.jpeg">
            </div>
          </div>
          <div class="pdp-destra">
            <div class="pdp-text">
              <i>Nike</i>
              <h1>Air Jordan 4 Retro 'Cool Grey' 2019</h1>
              
              <h3 id="prova">Descrizione</h3>
              <p>Ripubblicato nell'agosto 2019, l'Air Jordan 4 Retro 'Cool Grey' celebra il 30° anniversario dell'iconica sneaker in un retro fedele alla forma di una colorazione del 2004. La tomaia in nabuk Cool Grey è incorniciata da un'intersuola bianca che ospita un'unità Nike Air visibile, mentre i dettagli neri rivestono la suola e i passanti per i lacci. Un accenno di Varsity Maize appare sulla linguetta, sulla bolla d'aria e sulla suola, mentre un logo Jumpman cromato adorna il tallone posteriore.
              </p>
  
              <h4>Taglie</h4>
       <div class="grid-container">
       <form action="cool_grey.php#prova" method="get" style="display:contents;">
      ...
      <input type="text" name="nomeScarpa" value="Cool Grey 2019" hidden>
    <input type="number" name="prezzo" value="600" hidden>
    <input type="number" name="quantita" value="1" hidden>
    <button name="invia" class="add-cart" type="submit" checked>ACQUISTA - 600€</button>
    <?php
    if($controllo){

...
<html>
    <head>
        <title>Air Jordan 4 Retro 'Purple Metallic'</title>
...
<body>
  ...
  <div class="header" id="myHeader">
    ...
    <div class="contenitore-esterno">
      <section class="pdp-section">
        <div class="pdp-container-main">
          <div class="pdp-sinistra">
            <img class="foto1" src="../../img/Jordan4/PURPLE_METALLIC/tuttedue.jpeg">
            <div class="pdp-foto-metà">
              <img class="foto2" src="../../img/Jordan4/PURPLE_METALLIC/suola.jpeg">
              <img class="foto3" src="../../img/Jordan4/PURPLE_METALLIC/retro.jpeg">
            </div>
          </div>
          <div class="pdp-destra">
            <div class="pdp-text">
              <i>Nike</i>
      <h1>Air Jordan 4 Retro 'Purple Metallic'</h1>
	 
      <h3 id="prova">Descrizione</h3>
      <p>Lanciato come parte di un pacchetto Metallic di quattro pezzi, Air Jordan 4 Retro "Purple Metallic" mostra una semplice combinazione di colori bicolore sulla classica silhouette mid-top. La sneaker utilizza una struttura in pelle bianca incontaminata, accentata con schiocchi viola di colore contrastante sugli occhielli sagomati, suola Air visibile e colpi di marchio esterno, inclusi i loghi Jumpman firmati sull'etichetta della linguetta intrecciata e sul pannello del tallone.
      </p>
  
      <h4>Taglie</h4>
      <div class="grid-container">
      <form action="purple_metallic.php#prova" method="get" style="display:contents;">
     ...
     <input type="text" name="nomeScarpa" value="Purple Metallic" hidden>
    <input type="number" name="prezzo" value="630" hidden>
    <input type="number" name="quantita" value="1" hidden>
    <button name="invia" class="add-cart" type="submit" checked>ACQUISTA - 630€</button>
    <?php
    if($controllo){

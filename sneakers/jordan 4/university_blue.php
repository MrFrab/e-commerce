...
<html>
    <head>
        <title>Air Jordan 4 Retro 'University Blue'</title>
...
<body>
      ...
      <section class="pdp-section">
        <div class="pdp-container-main">
          <div class="pdp-sinistra">
            <img class="foto1" src="../../img/Jordan4/UNIVERSITY_BLUE/tuttedue.jpeg">
            <div class="pdp-foto-metà">
              <img class="foto2" src="../../img/Jordan4/UNIVERSITY_BLUE/suola.jpeg">
              <img class="foto3" src="../../img/Jordan4/UNIVERSITY_BLUE/retro.jpeg">
            </div>
          </div>
          <div class="pdp-destra">
            <div class="pdp-text">
              <i>Nike</i>
      <h1>Air Jordan 4 Retro 'University Blue'</h1>
	 
      <h3>Descrizione</h3>
      <p>L'Air Jordan 4 Retro "University Blue" aggiorna la classica silhouette con una tomaia in pelle scamosciata in una tonalità familiare ispirata all'alma mater UNC di Michael Jordan. La tavolozza blu brillante è contrastata da una finitura grigia maculata sulle ali di supporto e sul tallone posteriore della sneaker, con un'icona Jumpman rialzata in nero. Il marchio secondario Jumpman adorna l'etichetta della linguetta tessuta, progettata per imitare un'etichetta da atleta che appare tipicamente sull'orlo inferiore delle maglie Jordan.
      </p>
  ...
  <a href="#"> <button class="add-cart" checked>ACQUISTA - 500€</button> </a>
            </div>
          </div>
        </div>
      </section>

...
<html>
    <head>
        <title>Air Jordan 4 Retro 'White Oreo'</title>
...
<body>
      ...
      <section class="pdp-section">
        <div class="pdp-container-main">
          <div class="pdp-sinistra">
            <img class="foto1" src="../../img/Jordan4/WHITE_OREO/tuttedue.jpeg">
            <div class="pdp-foto-metà">
              <img class="foto2" src="../../img/Jordan4/WHITE_OREO/suola.jpeg">
              <img class="foto3" src="../../img/Jordan4/WHITE_OREO/retro.jpeg">
            </div>
          </div>
          <div class="pdp-destra">
            <div class="pdp-text">
              <i>Nike</i>
      <h1>Air Jordan 4 Retro 'White Oreo'</h1>
	 
      <h3>Descrizione</h3>
      <p>L'Air Jordan 4 Retro 'White Oreo' presenta un tema di design che ricorda l'originale 'Oreo' AJ4 del 1999. La tomaia in pelle martellata nera della scarpa più vecchia è sostituita da una finitura bianca pulita, anche se rimangono gli occhielli sagomati maculati in Tech Grey lo stesso. La tonalità neutra è ripetuta sul logo del tallone Jumpman e sull'intersuola in poliuretano, con ammortizzazione Air incapsulata nell'avampiede e unità visibile sotto il tallone. Un secondo Jumpman adorna la linguetta in un contrasto di Fire Red.
      </p>
  ...
  <a href="#"> <button class="add-cart" checked>ACQUISTA - 540€</button> </a>
            </div>
          </div>
        </div>
      </section>

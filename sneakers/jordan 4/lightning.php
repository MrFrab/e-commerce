...
<html>
    <head>
        <title>Air Jordan 4 Retro 'Lightning' 2021</title>
      ...
      <section class="pdp-section">
        <div class="pdp-container-main">
          <div class="pdp-sinistra">
            <img class="foto1" src="../../img/Jordan4/RETRO_LIGHTNING/tuttedue.jpeg">
            <div class="pdp-foto-metà">
              <img class="foto2" src="../../img/Jordan4/RETRO_LIGHTNING/suola.jpeg">
              <img class="foto3" src="../../img/Jordan4/RETRO_LIGHTNING/retro.jpeg">
            </div>
          </div>
          <div class="pdp-destra">
            <div class="pdp-text">
              <i>Nike</i>
<h1>Air Jordan 4 Retro 'Lightning' 2021</h1>

<h3 id="prova">Descrizione</h3>
<p>L'edizione 2021 di Air Jordan 4 Retro "Lightning" resuscita una colorazione molto ambita che originariamente è stata lanciata nel 2006 insieme a una colorazione "Thunder" di accompagnamento, entrambe ispirate al team Motorsports di Michael Jordan. Una tonalità giallo brillante inonda la tomaia in nabuk, contrastata dalla rete nera e dalle ali strutturali grigio scuro. Accenti grigi coordinati atterrano sull'etichetta della linguetta intrecciata, sulla linguetta interna e sul marchio Jumpman sul tallone. Un'intersuola in PU bianca, migliorata con l'ammortizzazione visibile della suola Air, scorre su una suola in gomma a spina di pesce grigio scuro.
</p>
  
<h4>Taglie</h4>
<div class="grid-container">

<form action="lightning.php#prova" method="get" style="display:contents;">
...
<input type="text" name="nomeScarpa" value="Lightning" hidden>
    <input type="number" name="prezzo" value="300" hidden>
    <input type="number" name="quantita" value="1" hidden>
    <button name="invia" class="add-cart" type="submit" checked>ACQUISTA - 300€</button>
    <?php
    if($controllo){

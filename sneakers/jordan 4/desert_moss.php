...
<html>
    <head>
        <title>Union LA x Air Jordan 4 Retro 'Desert Moss'</title>
...
<body>
  ...
  <div class="header" id="myHeader">
    ...
    <div class="contenitore-esterno">
      <section class="pdp-section">
        <div class="pdp-container-main">
          <div class="pdp-sinistra">
            <img class="foto1" src="../../img/Jordan4/DESERT_MOSS/tuttedue.jpeg">
            <div class="pdp-foto-metà">
              <img class="foto2" src="../../img/Jordan4/DESERT_MOSS/suola.jpeg">
              <img class="foto3" src="../../img/Jordan4/DESERT_MOSS/retro.jpeg">
            </div>
          </div>
          <div class="pdp-destra">
            <div class="pdp-text">
              <i>Nike</i>
      <h1>Union LA x Air Jordan 4 Retro 'Desert Moss'</h1>
	 
      <h3 id="prova">Descrizione</h3>
      <p>Presentate come parte delle celebrazioni per il 30° anniversario del famoso rivenditore, le Union LA x Air Jordan 4 Retro "Desert Moss" riportano in vita le AJ4 modificate dei partner creativi dal 2020. Questa coppia è tratta da una capsule soprannominata "Tent and Trail", con colori e materiali ispirati all'abbigliamento outdoor degli anni '80 e '90. Il mid-top porta una tomaia costruita con una miscela di mesh viola brillante e pelle scamosciata giallo senape. Vibranti schiocchi di turchese si posano sugli occhielli sagomati inferiori e sulla linguetta del tallone, contrassegnati dal marchio Nike Air in una tonalità lavanda. La linguetta ripiegata cucita, l'etichetta gialla "UN/LA" e le ali traslucide in TPU sono state riprese dalla versione 2020. La sneaker è montata su un'intersuola in poliuretano bianco sporco con un'unità Air-sole color acqua sotto il tallone.
      </p>
  
      <h4>Taglie</h4>
      <div class="grid-container">
      <form action="desert_moss.php#prova" method="get" style="display:contents;">
     ...
     <input type="text" name="nomeScarpa" value="Union LA Desert Moss" hidden>
    <input type="number" name="prezzo" value="590" hidden>
    <input type="number" name="quantita" value="1" hidden>
    <button name="invia" class="add-cart" type="submit" checked>ACQUISTA - 590€</button>
    <?php
    if($controllo){

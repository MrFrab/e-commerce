...
<html>
    <head>
        <title>StrangeLove x Dunk Low SB 'Valentine's Day'</title>
...
<body>
      ...
      <section class="pdp-section">
        <div class="pdp-container-main">
          <div class="pdp-sinistra">
            <img class="foto1" src="../../img/Dunk_Low/SB_STRANGELOVE/tuttedue.jpeg">
            <div class="pdp-foto-metà">
              <img class="foto2" src="../../img/Dunk_Low/SB_STRANGELOVE/suola.jpeg">
              <img class="foto3" src="../../img/Dunk_Low/SB_STRANGELOVE/retro.jpeg">
            </div>
          </div>
          <div class="pdp-destra">
            <div class="pdp-text">
              <i>Nike</i>
      <h1>StrangeLove x Dunk Low SB 'Valentine's Day'</h1>
	 
      <h3>Descrizione</h3>
      <p>Realizzato in collaborazione con il marchio skate di Sean Cliver, lo StrangeLove x Dunk Low SB QS "San Valentino" celebra la vacanza romantica con una lussuosa interpretazione della silhouette retrò. La tomaia è realizzata in velluto bianco schiacciato con sovrapposizioni in pelle scamosciata rosa e uno Swoosh in velluto rosso. La grafica "Heart Skull" di Cliver è ricamata sul tallone laterale, mentre la suola in gomma rosa traslucida rivela una serie di cuori sparsi nei toni contrastanti del rosso e del blu.
      </p>
  ...
  <a href="#"> <button class="add-cart" checked>ACQUISTA - 1400€</button> </a>
            </div>
          </div>
        </div>
      </section>

...
<html>
    <head>
        <title>Dunk Low 'Michigan' 2021</title>
      ...
      <section class="pdp-section">
        <div class="pdp-container-main">
          <div class="pdp-sinistra">
            <img class="foto1" src="../../img/Dunk_Low/MICHIGAN/tuttedue.jpeg">
            <div class="pdp-foto-metà">
              <img class="foto2" src="../../img/Dunk_Low/MICHIGAN/suola.jpeg">
              <img class="foto3" src="../../img/Dunk_Low/MICHIGAN/retro.jpeg">
            </div>
          </div>
          <div class="pdp-destra">
            <div class="pdp-text">
              <i>Nike</i>
              <h1>Dunk Low 'Michigan' 2021</h1>
              
              <h3>Descrizione</h3>
              <p>La Nike Dunk Low "Michigan" del 2021 offre una versione low-top di una delle colorazioni originali "Be True to Your School" della silhouette, rilasciata per la prima volta nel 1985 e precedentemente retrodatata nel 2020. La tomaia interamente in pelle arriva in un ricco Varsity Maize tonalità con accenti Midnight Navy a contrasto sullo Swoosh e sull'avampiede e sul tallone. Un colletto a taglio basso e una linguetta in nylon traspirante con il tradizionale marchio Nike assicurano un comfort imbottito.
              </p>
              <h4>Taglie</h4>

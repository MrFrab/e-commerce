...
<html>
    <head>
        <title>Dunk Low 'Black White'</title>
      ...
      <section class="pdp-section">
        <div class="pdp-container-main">
          <div class="pdp-sinistra">
            <img class="foto1" src="../../img/Dunk_Low/B_White/tuttedue.jpeg">
            <div class="pdp-foto-metà">
              <img class="foto2" src="../../img/Dunk_Low/B_White/suola.jpeg">
              <img class="foto3" src="../../img/Dunk_Low/B_White/retro.jpeg">
            </div>
          </div>
          <div class="pdp-destra">
            <div class="pdp-text">
              <i>Nike</i>
      <h1>Dunk Low 'Black White'</h1>
	 
      <h3
id="prova">Descrizione</h3>
      <p>La Nike Dunk Low "Black White" tratta il modello retrò con un'essenziale combinazione di colori bicolore che accentua le linee pulite della sneaker, sviluppata dal designer Peter Moore e responsabile della facile transizione della scarpa dal legno duro alla strada. La tomaia in pelle combina una base bianca con sovrapposizioni nere a contrasto che avvolgono la punta e il tallone. Sia sull'etichetta della linguetta in tessuto che sulla linguetta del tallone, il marchio Nike in bianco risalta in rilievo su uno sfondo nero.
      </p>
      <h4>Taglie</h4>
      <div class="grid-container">
      <form action="bw_low.php#prova" method="get" style="display:contents;">
     ...
     <input type="text" name="nomeScarpa" value="Dunk Low Black White" hidden>
    <input type="number" name="prezzo" value="125" hidden>
    <input type="number" name="quantita" value="1" hidden>
    <button name="invia" class="add-cart" type="submit" checked>ACQUISTA - 125€</button>
    <?php
    if($controllo){

...
<html>
    <head>
        <title>Dunk Low Retro Vol. 1 SP 'Plum'</title>
      ...
      <section class="pdp-section">
        <div class="pdp-container-main">
          <div class="pdp-sinistra">
            <img class="foto1" src="../../img/Dunk_Low/PLUM/tuttedue.jpeg">
            <div class="pdp-foto-metà">
              <img class="foto2" src="../../img/Dunk_Low/PLUM/suola.jpeg">
              <img class="foto3" src="../../img/Dunk_Low/PLUM/retro.jpeg">
            </div>
          </div>
          <div class="pdp-destra">
            <div class="pdp-text">
              <i>Nike</i>
<h1>Dunk Low Retro Vol. 1 SP 'Plum'</h1>

<h3>Descrizione</h3>
<p>La riedizione 2020 del Dunk Low Retro Vol. 1 SP 'Plum' riporta una colorazione classica rilasciata per la prima volta nel 2001 come parte della serie co.jp esclusiva di Nike per il Giappone. Come l'originale, questo paio presenta una finitura viola bicolore su una tomaia tutta in pelle scamosciata burrosa, con tocchi contrastanti di rosso scuro su Swoosh, linguetta sul tallone e lacci. Le corse basse su un'intersuola in schiuma bianca, supportata sotto i piedi da una suola in gomma rossa.
</p>
<h4>Taglie</h4>
<div class="grid-container">
 ...
 <a href="#"> <button class="add-cart" checked>ACQUISTA - 430€</button> </a>
            </div>
          </div>
        </div>
      </section>

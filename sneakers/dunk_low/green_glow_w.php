...
<html>
    <head>
        <title>Wmns Dunk Low 'Green Glow'</title>
      ...
      <section class="pdp-section">
        <div class="pdp-container-main">
          <div class="pdp-sinistra">
            <img class="foto1" src="../../img/Dunk_Low/GREEN_GLOW_W/tuttedue.jpeg">
            <div class="pdp-foto-metà">
              <img class="foto2" src="../../img/Dunk_Low/GREEN_GLOW_W/suola.jpeg">
              <img class="foto3" src="../../img/Dunk_Low/GREEN_GLOW_W/retro.jpeg">
            </div>
          </div>
          <div class="pdp-destra">
            <div class="pdp-text">
              <i>Nike</i>
              <h1>Wmns Dunk Low 'Green Glow'</h1>
              
              <h3 id="prova">Descrizione</h3>
              <p>La scarpa Nike Dunk Low "Green Glow" da donna mette in mostra i tradizionali blocchi di colore su una consueta struttura interamente in pelle. Una base bianca nitida è contrastata da una vibrante tonalità di verde sull'occhiello della sneaker, sullo Swoosh e sulle sovrapposizioni dell'avampiede e del tallone. La tonalità verdeggiante è ripetuta sull'etichetta della linguetta intrecciata e sulla linguetta del tallone, entrambe contrassegnate dal marchio Nike standard. Il low-top scorre su una suola in gomma bicolore, dotata di una suola aderente originariamente progettata per ruotare sul legno duro.
              </p>
              
  
              <h4>Taglie</h4>
<div class="grid-container">
<form action="green_glow_w.php#prova" method="get" style="display:contents;">
...
<input type="text" name="nomeScarpa" value="Wmns Dunk Low Green Glow" hidden>
    <input type="number" name="prezzo" value="250" hidden>
    <input type="number" name="quantita" value="1" hidden>
    <button name="invia" class="add-cart" type="submit" checked>ACQUISTA - 250€</button>
    <?php
    if($controllo){

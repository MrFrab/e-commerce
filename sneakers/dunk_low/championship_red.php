...
<html>
    <head>
        <title>Dunk Low 'Championship Red'</title>
...
<body>
  ...
  <div class="header" id="myHeader">
    ...
    <div class="contenitore-esterno">
      <section class="pdp-section">
        <div class="pdp-container-main">
          <div class="pdp-sinistra">
            <img class="foto1" src="../../img/Dunk_Low/CHAMPIONSHIP_RED/tuttedue.jpeg">
            <div class="pdp-foto-metà">
              <img class="foto2" src="../../img/Dunk_Low/CHAMPIONSHIP_RED/suola.jpeg">
              <img class="foto3" src="../../img/Dunk_Low/CHAMPIONSHIP_RED/retro.jpeg">
            </div>
          </div>
          <div class="pdp-destra">
            <div class="pdp-text">
              <i>Nike</i>
      <h1>Dunk Low 'Championship Red'</h1>
	 
      <h3 id="prova">Descrizione</h3>
      <p>La Nike Dunk Low "Championship Red" presenta semplici blocchi di colore bicolore in linea con la serie introduttiva della scarpa "Be True to Your School" del 1985. La tomaia in pelle abbina una base cremisi con sovrapposizioni bianche a contrasto sull'avampiede e sul tallone. Il marchio Nike standard si fa strada sulla soletta, sulla linguetta del tallone e sull'etichetta della linguetta in tessuto. La sneaker scorre su una tradizionale suola in gomma preformata, evidenziata dai fianchi bianchi e da una suola in gomma rossa aderente.
      </p>
      <h4>Taglie</h4>
  
      <div class="grid-container">
      <form action="championship_red.php#prova" method="get" style="display:contents;">
      ...
      <input type="text" name="nomeScarpa" value="Dunk Low Championship Red" hidden>

...
<html>
    <head>
        <title>Dunk-high Black and White</title>
    ...
    <section class="pdp-section">
      <div class="pdp-container-main">
        <div class="pdp-sinistra">
          <img   class="foto1" src="../../img/Dunk_High/B_White/tuttedue.jpeg">
          <div class="pdp-foto-metà">
            <img class="foto2" src="../../img/Dunk_High/B_White/suola.jpeg">
            <img class="foto3" src="../../img/Dunk_High/B_White/retro.jpeg">
          </div>
        </div>
        <div class="pdp-destra">
          <div class="pdp-text">
            <i>Nike</i>
            <h1>DUNK HIGH 'BLACK WHITE'</h1>
            
            <h3 id="prova">Descrizione</h3>
            <p>La Dunk High 'Black White' porta un classico look bicolore a una classica silhouette alta. Costruita in pelle, la tomaia della scarpa appare in un mix di bianco e nero, contrastato solo dal rosso sull'etichetta della linguetta intrecciata. La punta è perforata per offrire traspirabilità, mentre la suola a coppa in gomma fissa la struttura e mantiene l'aspetto in bianco e nero. Una suola in gomma concentrica è inclusa per la trazione.
            </p>
            ...
            <form action="bw.php#prova" method="get" style="display:contents;">
            ...
            <input type="text" name="nomeScarpa" value="DUNK HIGH BLACK WHITE" hidden>
            <input type="text" name="prezzo" value="125" hidden>

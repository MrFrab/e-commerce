...
<html>
    <head>
        <title>Dunk High SB 'Maui Wowie'</title>
    ...
    <section class="pdp-section">
      <div class="pdp-container-main">
        <div class="pdp-sinistra">
          <img class="foto1" src="../../img/Dunk_High/SB_HAWAII/tuttedue.jpeg">
          <div class="pdp-foto-metà">
            <img class="foto2" src="../../img/Dunk_High/SB_HAWAII/suola.jpeg">
            <img class="foto3" src="../../img/Dunk_High//SB_HAWAII/retro.jpeg">
          </div>
        </div>
        <div class="pdp-destra">
          <div class="pdp-text">
            <i>Nike</i>
            <h1>Dunk High SB 'Maui Wowie'</h1>
            
            <h3 id="prova">Descrizione</h3>
            <p>La Nike Dunk High SB "Maui Wowie" utilizza una tomaia in tessuto con stampa floreale, accentata con canapa non tinta sullo Swoosh e sulla linguetta. Lo strato esterno sulla punta e sui pannelli laterali è progettato per strapparsi, rivelando una diversa stampa floreale resa in tonalità rosso fuoco e arancio. Gli strati esterni dell'avampiede e del tallone della sneaker, nel frattempo, presentano una pelle scamosciata verde arruffata sotto lo strato superficiale a strappo. La disposizione multicolore in alto è contrastata da un'intersuola bianca croccante, supportata sotto i piedi da una suola in gomma color crema.
            </p>
            ...
            <form action="sb_hawaii.php#prova" method="get" style="display:contents;">
           ...
           <input type="text" name="nomeScarpa" value="Dunk High SB Maui Wowie" hidden>
            <input type="number" name="prezzo" value="270" hidden>
            <input type="number" name="quantita" value="1" hidden>
            <button name="invia" class="add-cart" type="submit" checked>ACQUISTA - 270€</button>
            <?php
    if($controllo){

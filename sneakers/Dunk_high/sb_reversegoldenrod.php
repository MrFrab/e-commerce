...
<html>
    <head>
        <title>Dunk High Pro SB 'Reverse Goldenrod'</title>
    ...
    <section class="pdp-section">
      <div class="pdp-container-main">
        <div class="pdp-sinistra">
          <img class="foto1" src="../../img/Dunk_High/SB_REVERSEGOLDENROD/tuttedue.jpeg">
          <div class="pdp-foto-metà">
            <img class="foto2" src="../../img/Dunk_High/SB_REVERSEGOLDENROD/suola.jpeg">
            <img class="foto3" src="../../img/Dunk_High/SB_REVERSEGOLDENROD/retro.jpeg">
          </div>
        </div>
        <div class="pdp-destra">
          <div class="pdp-text">
            <i>Nike</i>
            <h1>Dunk High Pro SB 'Reverse Goldenrod'</h1>
          ...
          <a href="#"> <button class="add-cart" checked>ACQUISTA - 170€</button> </a></div>
        </div>
      </div>
    </section>

...
<html>
    <head>
        <title>Dunk High SB 'Strawberry Cough'</title>
    ...
    <section class="pdp-section">
      <div class="pdp-container-main">
        <div class="pdp-sinistra">
          <img class="foto1" src="../../img/Dunk_High/SB_STRAWBERRY_COUGH/tuttedue.jpeg">
          <div class="pdp-foto-metà">
            <img class="foto2" src="../../img/Dunk_High/SB_STRAWBERRY_COUGH/suola.jpeg">
            <img class="foto3" src="../../img/Dunk_High/SB_STRAWBERRY_COUGH/retro.jpeg">
          </div>
        </div>
        <div class="pdp-destra">
          <div class="pdp-text">
            <i>Nike</i>
            <h1>Dunk High SB 'Strawberry Cough'</h1>
	 ...
	 <a href="#"> <button class="add-cart" checked>ACQUISTA - 400€</button> </a></div>
        </div>
      </div>
    </section>

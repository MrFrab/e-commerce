...
<html>
    <head>
        <title>Wmns Dunk High 'Aluminum'</title>
...
<section class="pdp-section">
  <div class="pdp-container-main">
    <div class="pdp-sinistra">
      <img  class="foto1" src="../../img/Dunk_High/ALUMINIUM_W/tuttedue.jpeg">
      <div class="pdp-foto-metà">
        <img class="foto2" src="../../img/Dunk_High/ALUMINIUM_W/suola.jpeg">
        <img class="foto3" src="../../img/Dunk_High/ALUMINIUM_W/retro.jpeg">
      </div>
    </div>
    <div class="pdp-destra">
      <div class="pdp-text">
        <i>Nike</i>
        <h1>Dunk High 'Aluminum'</h1>  
        <h3 id="prova">Descrizione</h3>
        <p>La Nike Dunk High High "Aluminum" si ispira all'alma mater di Michael Jordan, l'Università del North Carolina, con una tavolozza di colori bicolore dalla mentalità simile. La tomaia in pelle bianca presenta sovrapposizioni in alluminio su Swoosh, puntale, quarto e colletto. Il tema continua fino al marchio sulla linguetta azzurra e alla suola color block. Una suola con un motivo di trazione concentrico completa la costruzione.
        </p>
        ...
        <h4>Taglie</h4>
          ...
          <div class="grid-container">
            ...
            <form action="Aluminium_w.php#prova" method="get" style="display:contents;">
              ...
              <input type="text" name="nomeScarpa" value="Wmns Dunk High Aluminum" hidden>
              <input type="number" name="prezzo" value="190" hidden>
              <input type="number" name="quantita" value="1" hidden>
              <button name="invia" class="add-cart" type="submit" checked>ACQUISTA - 190€</button>
              <?php
              if($controllo){

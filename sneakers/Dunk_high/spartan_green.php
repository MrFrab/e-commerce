...
<html>
    <head>
        <title>Dunk High SP 'Spartan Green'</title>
    ...
    <section class="pdp-section">
      <div class="pdp-container-main">
        <div class="pdp-sinistra">
          <img class="foto1" src="../../img/Dunk_High/SPARTAN_GREEN/tuttedue.jpeg">
          <div class="pdp-foto-metà">
            <img class="foto2" src="../../img/Dunk_High/SPARTAN_GREEN/suola.jpeg">
            <img class="foto3" src="../../img/Dunk_High/SPARTAN_GREEN/retro.jpeg">
          </div>
        </div>
        <div class="pdp-destra">
          <div class="pdp-text">
            <i>Nike</i>
            <h1>Dunk High SP 'Spartan Green'</h1>

            <h3>Descrizione</h3>
            <p>La Nike Dunk High SP 'Spartan Green' mostra una semplice palette bicolore che ricorda la serie Be True to Your School del 1985. In questo caso, il design bianco e verde, eseguito su una tomaia interamente in pelle, trae ispirazione dall'università dello stato del Michigan. La parte superiore utilizza una linguetta in mesh per un comfort traspirante, accentata con un'etichetta Nike in tessuto per un'estetica OG. I calci sono stati lanciati nei negozi meno di una settimana prima del "Michigan" Dunk, completando un tema di rivalità intrastatale.
            </p>
            <h4>Taglie</h4>
...
<a href="#"> <button class="add-cart" checked>ACQUISTA - 350€</button> </a>
